## Project Overview
This project detects fire and smoke in real-time using a machine learning model. It uses the **YOLOv8 object detection algorithm** to identify fire or smoke from:
- 📷 Webcam (real-time detection)  
- 🖼️ Images  
The system draws bounding boxes around detected fire/smoke and can trigger an alert sound and sends email notifications with captured screenshots.

This is useful for **early fire detection, surveillance, and safety applications**.
...
- **Image Detection:** Users can upload an image to the project folder, and the system will detect fire and smoke in the image with bounding boxes and an optional alert sound.
...
## How to Run
### For Webcam (Real-Time Detection)
...
### For Image Detection
1. Place an image in the project folder, e.g. test.jpg or fire.jpg.

2. **Run the YOLOv8 Image Detection Script:**
   ```bash
